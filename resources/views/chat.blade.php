        ...
        @if ($selectedUser)
          <div class="chat-window p-3">
            ...
            <h5>
              ...
              // Determine the status class and text based on IsActive
              $statusClass = $authUser && $authUser->IsActive ? 'bg-success' : 'bg-secondary';
              $statusText = $authUser && $authUser->IsActive ? 'Online' : 'Offline';
          @endphp
